...
def main():
    ...
    if user_prompt:
            ...
            with st.spinner("Processing..."):  
                claim_info = requests.post('https://cov-comp-server.onrender.com/covcomp/gemini/claimval', json={"policy":extracted_text, "previous_result":st.session_state.chat_history[-2]["text"], "user_data":user_prompt})
